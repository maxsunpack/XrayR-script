...
```
bash <(curl -Ls https://raw.githubusercontents.com/maxsunpack/XrayR-script/master/install.sh)
```
# Docker 安装
...
```
1. `git clone https://github.com/maxsunpack/XrayR-script XrayR-release`
2. `cd XrayR-release`
3. 编辑config。
